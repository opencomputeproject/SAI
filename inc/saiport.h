...
{
    SAI_PORT_STAT_COUNTER_IF_IN_OCTETS,
    SAI_PORT_STAT_COUNTER_IF_IN_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IF_IN_NON_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IF_IN_DISCARDS,
    SAI_PORT_STAT_COUNTER_IF_IN_ERRORS,
    SAI_PORT_STAT_COUNTER_IF_IN_UNKNOWN_PROTOS,
    SAI_PORT_STAT_COUNTER_IF_IN_BROADCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IF_IN_MULTICAST_PKTS,
    SAI_PORT_STAT_COUNTER_IF_IN_VLAN_DISCARDS,
    SAI_PORT_STAT_COUNTER_IF_OUT_OCTETS,
    SAI_PORT_STAT_COUNTER_IF_OUT_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IF_OUT_NON_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IF_OUT_DISCARDS,
    SAI_PORT_STAT_COUNTER_IF_OUT_ERRORS,
    SAI_PORT_STAT_COUNTER_IF_OUT_QLEN,
    SAI_PORT_STAT_COUNTER_IF_OUT_BROADCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IF_OUT_MULTICAST_PKTS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_DROP_EVENTS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_MULTICAST_PKTS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_BROADCAST_PKTS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_UNDERSIZE_PKTS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_FRAGMENTS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_64_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_65_TO_127_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_128_TO_255_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_256_TO_511_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_512_TO_1023_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_1024_TO_1518_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_1519_TO_2047_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_2048_TO_4095_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_4096_TO_9216_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS_9217_TO_16383_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_OVERSIZE_PKTS,
    SAI_PORT_STAT_COUNTER_ETHER_RX_OVERSIZE_PKTS,
    SAI_PORT_STAT_COUNTER_ETHER_TX_OVERSIZE_PKTS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_JABBERS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_PKTS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_COLLISIONS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_CRC_ALIGN_ERRORS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_TX_NO_ERRORS,
    SAI_PORT_STAT_COUNTER_ETHER_STATS_RX_NO_ERRORS,
    SAI_PORT_STAT_COUNTER_IP_IN_RECEIVES,
    SAI_PORT_STAT_COUNTER_IP_IN_OCTETS,
    SAI_PORT_STAT_COUNTER_IP_IN_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IP_IN_NON_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IP_IN_DISCARDS,
    SAI_PORT_STAT_COUNTER_IP_OUT_OCTETS,
    SAI_PORT_STAT_COUNTER_IP_OUT_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IP_OUT_NON_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IP_OUT_DISCARDS,
    SAI_PORT_STAT_COUNTER_IPV6_IN_RECEIVES,
    SAI_PORT_STAT_COUNTER_IPV6_IN_OCTETS,
    SAI_PORT_STAT_COUNTER_IPV6_IN_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IPV6_IN_NON_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IPV6_IN_MCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IPV6_IN_DISCARDS,
    SAI_PORT_STAT_COUNTER_IPV6_OUT_OCTETS,
    SAI_PORT_STAT_COUNTER_IPV6_OUT_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IPV6_OUT_NON_UCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IPV6_OUT_MCAST_PKTS,
    SAI_PORT_STAT_COUNTER_IPV6_OUT_DISCARDS,
    /** get/set WRED green packet count [uint64_t] */
    SAI_PORT_STAT_COUNTER_GREEN_DISCARD_DROPPED_PACKETS,

    /** get/set WRED green byte count [uint64_t] */
    SAI_PORT_STAT_COUNTER_GREEN_DISCARD_DROPPED_BYTES,

    /** get/set WRED yellow packet count [uint64_t] */
    SAI_PORT_STAT_COUNTER_YELLOW_DISCARD_DROPPED_PACKETS,

    /** get/set WRED yellow byte count [uint64_t] */
    SAI_PORT_STAT_COUNTER_YELLOW_DISCARD_DROPPED_BYTES,

    /** get/set WRED red packet count [uint64_t] */
    SAI_PORT_STAT_COUNTER_RED_DISCARD_DROPPED_PACKETS,

    /** get/set WRED red byte count [uint64_t] */
    SAI_PORT_STAT_COUNTER_RED_DISCARD_DROPPED_BYTES,

    /** get/set WRED dropped packets count [uint64_t] */
    SAI_PORT_STAT_COUNTER_DISCARD_DROPPED_PACKETS,

    /** get/set WRED dropped bytes  count [uint64_t] */
    SAI_PORT_STAT_COUNTER_DISCARD_DROPPED_BYTES,

    /** get/set packets marked by ECN count [uint64_t] */
    SAI_PORT_STAT_COUNTER_ECN_MARKED_PACKETS,

    /** packet size based packets count */
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_64_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_65_TO_127_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_128_TO_255_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_256_TO_511_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_512_TO_1023_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_1024_TO_1518_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_1519_TO_2047_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_2048_TO_4095_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_4096_TO_9216_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_IN_PKTS_9217_TO_16383_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_64_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_65_TO_127_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_128_TO_255_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_256_TO_511_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_512_TO_1023_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_1024_TO_1518_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_1519_TO_2047_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_2048_TO_4095_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_4096_TO_9216_OCTETS,
    SAI_PORT_STAT_COUNTER_ETHER_OUT_PKTS_9217_TO_16383_OCTETS,

    /** get current port occupancy in bytes [uint64_t] */
    SAI_PORT_STAT_COUNTER_CURR_OCCUPANCY_BYTES,

    /** get watermark port occupancy in bytes [uint64_t] */
    SAI_PORT_STAT_COUNTER_WATERMARK_BYTES,

    /** get current port shared occupancy in bytes [uint64_t] */
    SAI_PORT_STAT_COUNTER_SHARED_CURR_OCCUPANCY_BYTES,

    /** get watermark port shared occupancy in bytes [uint64_t] */
    SAI_PORT_STAT_COUNTER_SHARED_WATERMARK_BYTES,

    /** get the number of pause frames received on the port [uint64_t] */
    SAI_PORT_STAT_COUNTER_PAUSE_RX_PKTS,

    /** get the number of pause frames transmitted on the port [uint64_t] */
    SAI_PORT_STAT_COUNTER_PAUSE_TX_PKTS,

    /** PFC Packet Counters for RX and TX per PFC priority [uint64_t] */
    SAI_PORT_STAT_COUNTER_PFC_0_RX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_0_TX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_1_RX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_1_TX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_2_RX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_2_TX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_3_RX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_3_TX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_4_RX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_4_TX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_5_RX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_5_TX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_6_RX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_6_TX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_7_RX_PKTS,
    SAI_PORT_STAT_COUNTER_PFC_7_TX_PKTS,
