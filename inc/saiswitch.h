...
typedef enum _sai_switch_restart_type_t
{
    ...
    SAI_RESTART_TYPE_PLANNED = 0,

    /** Unplanned restart only */
    SAI_RESTART_TYPE_UNPLANNED = 1,

    /** Both planned and unplanned restart */
    SAI_RESTART_TYPE_BOTH = 2,

    /** NPU doesn’t support warmboot */
    SAI_RESTART_TYPE_NONE = 3,
...
typedef enum _sai_switch_attr_t
{
    ...
    * may be modified */
    ...
    /** Nonvolatile storage required by both SAI and NPU [sai_uint64_t] 
