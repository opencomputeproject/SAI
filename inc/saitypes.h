...
typedef enum _sai_object_type_t
{
    ...
    SAI_OBJECT_TYPE_TAM_MATH_FUNC            = 70,
    SAI_OBJECT_TYPE_TAM_REPORT               = 71,
    SAI_OBJECT_TYPE_TAM_EVENT_THRESHOLD      = 72,
    SAI_OBJECT_TYPE_TAM_TEL_TYPE             = 73,
    SAI_OBJECT_TYPE_TAM_TRANSPORT            = 74,
    SAI_OBJECT_TYPE_TAM_IFA_HDR              = 75,
    SAI_OBJECT_TYPE_TAM_IFA_PROBE            = 76,
    SAI_OBJECT_TYPE_TAM_PROBE                = 77,
    SAI_OBJECT_TYPE_TAM_TELEMETRY            = 78,
    SAI_OBJECT_TYPE_TAM_COLLECTOR            = 79,
    SAI_OBJECT_TYPE_TAM_EVENT_ACTION         = 80,
    SAI_OBJECT_TYPE_TAM_EVENT                = 81,
