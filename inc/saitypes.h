...
typedef enum _sai_object_type_t
{
    ...
    SAI_OBJECT_TYPE_TAM_TEL_TYPE             = 79,
    SAI_OBJECT_TYPE_TAM_TRANSPORT            = 80,
    SAI_OBJECT_TYPE_TAM_IFA_HDR              = 81,
    SAI_OBJECT_TYPE_TAM_IFA_PROBE            = 82,
    SAI_OBJECT_TYPE_TAM_PROBE                = 83,
    SAI_OBJECT_TYPE_TAM_TELEMETRY            = 84,
    SAI_OBJECT_TYPE_TAM_COLLECTOR            = 85,
    SAI_OBJECT_TYPE_TAM_EVENT_ACTION         = 86,
    SAI_OBJECT_TYPE_TAM_EVENT                = 87,
