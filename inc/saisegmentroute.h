 ...
 */
typedef enum _sai_segmentroute_st_type_t
{
    /** Insertion of Segment Route Policy */
    SAI_SEGMENTROUTE_ST_TYPE_INSERT,

    /** Encapsulation in a Segment Route Policy and Source */
    SAI_SEGMENTROUTE_ST_TYPE_ENCAPS,

    /** Encapsulation in a Segment Route Policy and Ethernet */
    SAI_SEGMENTROUTE_ST_TYPE_ENCAPS_L2,

    /** Custom range base value */
    SAI_SEGMENTROUTE_ST_TYPE_CUSTOM_RANGE_BASE = 0x10000000

} sai_segmentroute_st_type_t;

/**
 * @brief Attribute data for SAI Segment Route Transit / Source Entry
 */
typedef enum _sai_segmentroute_st_attr_t
{
    /**
     * @brief Start of attributes
     */
    SAI_SEGMENTROUTE_ST_ATTR_START = 0x00000000,

    /**
     * @brief Transit or Source Type
     *
     * @type sai_segmentroute_st_type_t
     * @flags MANDATORY_ON_CREATE | CREATE_ONLY
     */
    SAI_SEGMENTROUTE_ST_ATTR_ST_TYPE = SAI_SEGMENTROUTE_ST_ATTR_START,
     ...
     * @flags READ_ONLY
     */
    SAI_SEGMENTROUTE_ST_ATTR_SUPPORTED_NUM_SEGMENTS,
     ...
     * @flags READ_ONLY
     */
    SAI_SEGMENTROUTE_ST_ATTR_SUPPORTED_TLV_TYPE,
     ...
     * @default empty
     */
    SAI_SEGMENTROUTE_ST_ATTR_TLV_LIST,
     ...
     * @default empty
     */
    SAI_SEGMENTROUTE_ST_ATTR_SEGMENT_LIST,

    /**
     * @brief End of attributes
     */
    SAI_SEGMENTROUTE_ST_ATTR_END,

    /** Custom range base value */
    SAI_SEGMENTROUTE_ST_ATTR_CUSTOM_RANGE_START = 0x10000000,

    /** End of custom range base */
    SAI_SEGMENTROUTE_ST_ATTR_CUSTOM_RANGE_END
} sai_segmentroute_st_attr_t;
...
/**
 * @brief Create Source / Transit Policy
 *
 ...
 */
typedef sai_status_t (*sai_create_segmentroute_st_fn)(
...
/**
 * @brief Remove Source / Transit Policy
 *
 * @param[in] policy_id Policy ID
 *
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
typedef sai_status_t (*sai_remove_segmentroute_st_fn)(
        _In_ sai_object_id_t policy_id);

/**
 * @brief Set Source / Transit Policy attribute value
 *
 * @param[in] policy_id Policy ID
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
typedef sai_status_t (*sai_set_segmentroute_st_attribute_fn)(
        _In_ sai_object_id_t policy_id,
        _In_ const sai_attribute_t *attr);

/**
 * @brief Get Source / Transit Policy attribute value
 *
 * @param[in] policy_id Policy ID
 * @param[in] attr_count Number of attributes
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
typedef sai_status_t (*sai_get_segmentroute_st_attribute_fn)(
        _In_ sai_object_id_t policy_id,
        _In_ uint32_t attr_count,
...
{
    sai_create_segmentroute_st_fn create_segmentroute_st;
    sai_remove_segmentroute_st_fn remove_segmentroute_st;
    sai_set_segmentroute_st_attribute_fn set_segmentroute_st_attribute;
    sai_get_segmentroute_st_attribute_fn get_segmentroute_st_attribute;
