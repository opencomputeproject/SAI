...
typedef enum _sai_acl_entry_attr_t
{
     ...
     * @flags CREATE_AND_SET
     * @objects SAI_OBJECT_TYPE_BRIDGE_PORT, SAI_OBJECT_TYPE_LAG, SAI_OBJECT_TYPE_NEXT_HOP, SAI_OBJECT_TYPE_NEXT_HOP_GROUP, SAI_OBJECT_TYPE_BRIDGE_PORT, SAI_OBJECT_TYPE_L2MC_GROUP, SAI_OBJECT_TYPE_IPMC_GROUP
     * @default disabled
     */
     ...
     * @flags CREATE_AND_SET
     * @objects SAI_OBJECT_TYPE_BRIDGE_PORT, SAI_OBJECT_TYPE_LAG, SAI_OBJECT_TYPE_NEXT_HOP, SAI_OBJECT_TYPE_NEXT_HOP_GROUP
     * @default disabled
     */
