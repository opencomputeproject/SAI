 ...
 */
#define SAI_STATUS_IS_INVALID_ATTRIBUTE(x)      ((SAI_STATUS_CODE(x) & (~0xFFFF)) == SAI_STATUS_CODE(SAI_STATUS_INVALID_ATTRIBUTE_0))

/**
 * @brief Is invalid attribute value helper
 */
#define SAI_STATUS_IS_INVALID_ATTR_VALUE(x)     ((SAI_STATUS_CODE(x) & (~0xFFFF)) == SAI_STATUS_CODE(SAI_STATUS_INVALID_ATTR_VALUE_0))

/**
 * @brief Is attribute not implemented helper
 */
#define SAI_STATUS_IS_ATTR_NOT_IMPLEMENTED(x)   ((SAI_STATUS_CODE(x) & (~0xFFFF)) == SAI_STATUS_CODE(SAI_STATUS_ATTR_NOT_IMPLEMENTED_0))

/**
 * @brief Is unknown attribute helper
 */
#define SAI_STATUS_IS_UNKNOWN_ATTRIBUTE(x)      ((SAI_STATUS_CODE(x) & (~0xFFFF)) == SAI_STATUS_CODE(SAI_STATUS_UNKNOWN_ATTRIBUTE_0))

/**
 * @brief Is attribute not supported helper
 */
#define SAI_STATUS_IS_ATTR_NOT_SUPPORTED(x)     ((SAI_STATUS_CODE(x) & (~0xFFFF)) == SAI_STATUS_CODE(SAI_STATUS_ATTR_NOT_SUPPORTED_0))
