...
/**
 * @brief Attribute ID for dash_vnet_inbound_eni_to_vm_entry
 */
typedef enum _sai_inbound_eni_to_vm_entry_attr_t
{
    ...
    /**
     * @brief Action set_vm_id parameter INBOUND_VM_ID
     *
     * @type sai_object_id_t
     * @flags CREATE_AND_SET
     * @objects SAI_OBJECT_TYPE_INBOUND_VM
     * @allownull true
     * @default SAI_NULL_OBJECT_ID
     */
    SAI_INBOUND_ENI_TO_VM_ENTRY_ATTR_INBOUND_VM_ID = SAI_INBOUND_ENI_TO_VM_ENTRY_ATTR_START,
...
/**
 * @brief Attribute ID for dash_vnet_inbound_vm
 */
...
/**
 * @brief Create dash_vnet_inbound_eni_to_vm_entry
 *
...
/**
 * @brief Remove dash_vnet_inbound_eni_to_vm_entry
 *
 * @param[in] inbound_eni_to_vm_entry Entry
 *
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
...
/**
 * @brief Set attribute for dash_vnet_inbound_eni_to_vm_entry
 *
 * @param[in] inbound_eni_to_vm_entry Entry
...
/**
 * @brief Get attribute for dash_vnet_inbound_eni_to_vm_entry
 *
 * @param[in] inbound_eni_to_vm_entry Entry
 * @param[in] attr_count Number of attributes
...
/**
 * @brief Bulk create dash_vnet_inbound_eni_to_vm_entry
 *
...
/**
 * @brief Bulk remove dash_vnet_inbound_eni_to_vm_entry
 *
...
/**
 * @brief Create dash_vnet_inbound_vm
 *
...
/**
 * @brief Remove dash_vnet_inbound_vm
 *
...
/**
 * @brief Set attribute for dash_vnet_inbound_vm
 *
 * @param[in] inbound_vm_id Entry id
 * @param[in] attr Attribute
 *
...
/**
 * @brief Get attribute for dash_vnet_inbound_vm
 *
 * @param[in] inbound_vm_id Entry id
 * @param[in] attr_count Number of attributes
 * @param[inout] attr_list Array of attributes
