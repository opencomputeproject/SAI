...
class RouteRifv6Test(T0TestBase):
    ...
    def runTest(self):
        ...
        3. Verify packet received with SMAC: SWITCH_MAC SIP: 192.168.0.1 DIP:fc02::12:1~8 on one of LAG2 member
        """
