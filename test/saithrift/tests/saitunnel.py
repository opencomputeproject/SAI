...
class IpIpEncapTest(sai_base_test.ThriftInterfaceDataPlane):
    ...
    def runTest(self):
        ...
        sai_thrift_create_route(self.client, vr_id=vr_id, addr_family=addr_family, ip_addr=ip_addr_encap_route, ip_mask=ip_mask_encap_route, nhop=encap_if_id)
        ...
        try:
            ...
            sai_thrift_remove_route(self.client,vr_id,addr_family,ip_addr_encap_route,ip_mask_encap_route,encap_if_id) 
...
class IpIpP2PTunnelDecapTest(sai_base_test.ThriftInterfaceDataPlane):
    ...
    def runTest(self):
        ...
        sai_thrift_create_route(self.client, vr_id=vr_id, addr_family=addr_family, ip_addr=ip_addr_egress_route, ip_mask=ip_mask_egress_route, nhop=egress_if_id)
        #adding tunnel and route
        sai_thrift_create_route(self.client, vr_id=vr_id, addr_family=addr_family, ip_addr=tunnel_ip_addr_route, ip_mask=tunnel_ip_mask_route, nhop=ingress_if_id)
        ...
        try:
            ...
            sai_thrift_remove_route(self.client,vr_id,addr_family,tunnel_ip_addr_route,tunnel_ip_mask_route,ingress_if_id) 

            sai_thrift_remove_route(self.client,vr_id,addr_family,ip_addr_egress_route,ip_mask_egress_route,egress_if_id) 
