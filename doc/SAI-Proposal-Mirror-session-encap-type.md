...
1) New enum fields have been added in sai_erspan_encapsulation_type_t to support GRE with ERSPAN Type II and Type III headers. 
   ```c
     ...
     */.
    SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL_ERSPAN_TYPE_III,
   ```
2) Attribute to configure session_id of ERSPAN-II and ERSPAN-III header:
   ...
   /**
     ...
     * @isvlan false
     * @default 0
     * @validonly SAI_MIRROR_SESSION_ATTR_ERSPAN_ENCAPSULATION_TYPE == SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL_ERSPAN_TYPE_II or SAI_MIRROR_SESSION_ATTR_ERSPAN_ENCAPSULATION_TYPE == SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL_ERSPAN_TYPE_III
     */
...
3) Attribute to update first 16 bits of GRE header
   ...
   /**
     ...
     * @isvlan false
     * @default internal
     * @validonly SAI_MIRROR_SESSION_ATTR_ERSPAN_ENCAPSULATION_TYPE == SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL
     */
...
sai_attr_list[attr_count++].value.u32 = SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL_ERSPAN_TYPE_II;
...
...(Existing Attribute)
sai_attr_list[attr_count].id = SAI_MIRROR_SESSION_ATTR_ERSPAN_ENCAPSULATION_TYPE;
sai_attr_list[attr_count++].value.u32 = SAI_ERSPAN_ENCAPSULATION_TYPE_MIRROR_L3_GRE_TUNNEL_ERSPAN_TYPE_III;
sai_attr_list[attr_count].id = SAI_MIRROR_SESSION_ATTR_ERSPAN_SESSION_ID;
