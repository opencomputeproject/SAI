...
const unsigned TableAttributes::defaultTableSize = 128;   // Flex ACL table size is limited
const cstring SaiModelProperties::jsonMetadataParameterName = "standard_metadata";
const cstring SaiModelProperties::validField = "$valid$";
